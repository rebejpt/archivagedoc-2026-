...
//                 const myDocsRes = await axios.get('/web-api/documents?per_page=5&filter=mine');
...
//         if (isAdmin) {
//             actions.push(
//                 { name: 'Uploader', icon: Upload, href: '/documents/upload', color: 'bg-blue-500', description: 'Ajouter un document' },
//                 { name: 'Nouvelle catégorie', icon: FolderTree, href: '/categories', color: 'bg-green-500', description: 'Créer une catégorie' },
//                 { name: 'Nouveau tag', icon: Tags, href: '/tags', color: 'bg-purple-500', description: 'Créer un tag' },
//                 { name: 'Gérer utilisateurs', icon: Users, href: '/users', color: 'bg-orange-500', description: 'Administration' }
//             );
//         } 
...
//         else {
//             actions.push(
//                 { name: 'Explorer', icon: FileText, href: '/documents', color: 'bg-gray-500', description: 'Voir tous les documents' },
//                 { name: 'Catégories', icon: FolderTree, href: '/categories', color: 'bg-gray-500', description: 'Parcourir par catégorie' },
//                 { name: 'Tags', icon: Tags, href: '/tags', color: 'bg-gray-500', description: 'Parcourir par tag' }
//             );
//         }
...
//                 </h1>
//                 <p className="text-gray-500 mt-1">{welcome.subtitle}</p>
//             </div>
...
//                                 key={index}
//                                 href={action.href}
//                                 className="bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow p-6 flex items-center group"
//                             >
...
//                             Documents récents
//                         </h2>
//                         <Link href="/documents" className="text-sm text-blue-600 hover:text-blue-800 flex items-center">
...
//                                         </div>
//                                         <div>
//                                             <Link href={`/documents/${doc.id}`} className="text-sm font-medium text-gray-800 hover:text-blue-600">
//                                                 {doc.title}
//                                             </Link>
//                                             <div className="flex items-center text-xs text-gray-400 mt-1">
//                                                 <span>{doc.category?.name || 'Non catégorisé'}</span>
...
//                                 Mes documents
//                             </h2>
//                             <Link href="/documents?filter=mine" className="text-sm text-green-600 hover:text-green-800 flex items-center">
//                                 Voir tout <ChevronRight size={14} className="ml-1" />
//                             </Link>
//                         </div>
...
//                                 <p className="text-gray-500">Vous n'avez pas encore uploadé de document</p>
//                                 {can.uploadDocuments && (
//                                     <Link href="/documents/upload" className="inline-block mt-3 text-sm text-blue-600 hover:text-blue-800">
//                                         Uploader maintenant
//                                     </Link>
//                                 )}
//                             </div>
...
//                                             </div>
//                                             <div>
//                                                 <Link href={`/documents/${doc.id}`} className="text-sm font-medium text-gray-800 hover:text-green-600">
//                                                     {doc.title}
//                                                 </Link>
//                                                 <div className="flex items-center text-xs text-gray-400 mt-1">
//                                                     <span>{doc.category?.name || 'Non catégorisé'}</span>
...
//                                 </div>
//                                 <div>
//                                     <p className="text-sm text-gray-800">3 nouveaux documents ajoutés</p>
...
//                                 </div>
//                                 <div>
//                                     <p className="text-sm text-gray-800">Nouvelle catégorie "Rapports"</p>
